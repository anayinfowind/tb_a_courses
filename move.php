...
/**
 * Move/order course functionality for tb_a_courses block.
 *
...
list($courses, $sitecourses, $coursecount) = block_tb_a_courses_get_sorted_courses();
...
block_tb_a_courses_update_myorder(array_values($neworder));
redirect(new moodle_url('/my/index.php'));
